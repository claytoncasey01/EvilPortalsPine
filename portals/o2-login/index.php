...
<body>
    ...
    <section class="login-form-wrap">
        ...
        <form class="login-form" method="POST" action="/captiveportal/index.php" onsubmit="redirect()">
            ...
            <h2>Login to access <?=getClientSSID($_SERVER['REMOTE_ADDR']);?></h2>
            ...
            <!-- <input type="number" name="mobile" placeholder="US mobile number" _autofocus="true" autocorrect="off" autocomplete="off" autocapitalize="off" required> -->
